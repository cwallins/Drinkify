...
export default function Search() {
    ...
    const userInput = 'Margarita'; //arg for Drinks later
    ...
    function handleClick() {
        // kontrollera input
        // const userInput = document.getElementById('user-input').val;
        ...
        <div>
            <div className="search-container">
                <div className="search">
                    <input id="user-input" type="text" placeholder="Have a drink..." className="search-field" />
            ...
            <div className="drinks-container">
                {drinks.map((drink, i) => {
                    return (
                        <div data-drink-id={drink.id}>
                            <Drink key={i} item={drink} />
                        </div>
                    );
                })}
            </div>
